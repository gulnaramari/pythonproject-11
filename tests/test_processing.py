...
def test_filter_by_state(
    test_initial_list: list[dict[str, Any]], state: str, expected: list[dict[str, Any]]
) -> Any:
...
def test_filter_by_state_empty(
    test_initial_list: list[dict[str, Any]], state: str
) -> Any:
...
def test_sort_by_date(
    test_initial_list: list[dict[str, Any]],
    reverse: bool,
...
def test_sort_by_date_without_date(test_initial_list: list[dict[str, Any]]) -> Any:
    with pytest.raises(TypeError):
    ...
    [
        (
            [
                "id939719570",
                "stateEXECUTED",
                "date2018-06-30T02:08:58.425572",
                "id342719570state:EXECUTED",
